...
def EPR():
  ...
  # オシロのチャンネル2とチャンネル3の波形を同時に取得
  Osc.write(":WAVeform:SOURce CHANnel2; :WAVeform:DATA?")
  OscData_CH2 = Osc.read_raw()
  Osc.write(":WAVeform:SOURce CHANnel3; :WAVeform:DATA?")
  OscData_CH3 = Osc.read_raw()
